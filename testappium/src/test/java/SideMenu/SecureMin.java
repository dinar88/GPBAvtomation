...
public class SecureMin extends Base {
    ...
    public void settings() {
        ...
        driver.findElement(By.name("Важные советы")).click();
        Selenide.sleep(5000);
        driver.findElement(By.xpath("//android.widget.Button[@bounds='[924,276][1044,402]']")).click();
