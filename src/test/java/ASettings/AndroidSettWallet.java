...
public class AndroidSettWallet extends BaseAndroid {
    @Test
    ...
    @Test
    @Description("This test checks properly working of Wallets button")

    public void Step2Wallets() {
        Selenide.sleep(2000);
    ...
    @Test
    @Description("This test checks wallet changing")

    public void Step3ChoosingWallet() {
        Selenide.sleep(2000);
        // xpath тут класс в аппиум сканер смотрим потом прописать bounds
        //driver.findElement(By.xpath("//android.view.ViewGroup[@bounds='[42,474][1038,684]']")).click();
        //driver.findElement(By.xpath("//android.widget.TextView[@bounds='[228,456][588,517]']")).click();
        ...
        // тут элемент находится классу и по тексту элемента
        driver.findElement(By.xpath("//android.widget.TextView[@text='123']")).click();
