...
public class AndroidSubscan extends BaseAndroid {
    @Test
    ...
    public void Step6ViewInSubscan() {
        Selenide.sleep(2000);

        // тут элемент находится классу и по тексту элемента
        driver.findElement(By.xpath("//android.widget.TextView[@text='View in Subscan']")).click();
        Selenide.sleep(5000);
